  ...
  <div>
    <v-card outlined v-if="!loading">
      <div style="padding-left: 180px; padding-bottom: 40px">
        ...
        <v-card-text>
          <h4 v-if="exercises.length === 0">
            No hay ejercicios para este ciclo
          </h4>
                    ...
                    <div class="d-flex flex-column">
                      ...
                      <div>
                        ...
                        <span v-if="exercise.type !== 'Repeticiones'">
                          {{ exercise.duration }}
                          {{ exercise.duration === 1 ? "segundo" : "segundos" }}
                        </span>
                      </div>
                    </div>
      ...
      >
        <div>
          <h1 class="font-weight-bold d-inline">{{ this.cycleRepetitions }}</h1>
          <h4 class="d-inline">reps.</h4>
        </div>
      </div>
    </v-card>
    <v-skeleton-loader
